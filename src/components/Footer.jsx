...
export const Footer = () => {
    return (
        <footer className="container-fluid" id="footer">
            <section className="row slider-foot">
            ...
            <div className="row bg-dark text-light px-5 py-4 gap-3 gap-lg-0">
                <div className="col-lg-4 text-center">
                    <p className="">Sarahí Rodríguez Bueno &copy;</p>
                </div>
                <div className="nav col-lg-4 justify-content-center align-items-center pb-3 pb-lg-0">
